 ...
 */
static long
xdl_split(unsigned long const *ha1, long off1, long lim1,
          unsigned long const *ha2, long off2, long lim2, long *kvdf,
          long *kvdb, int need_min, xdpsplit_t *spl, xdalgoenv_t *xenv)
{
...
static xdchange_t *
xdl_add_change(xdchange_t *xscr, long i1, long i2, long chg1, long chg2)
{
	xdchange_t *xch;
...
int
xdl_diff(mmfile_t *mf1, mmfile_t *mf2, xpparam_t const *xpp,
